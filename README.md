...
## Introduction
SPREADSHEET is a [Psi](https://github.com/Vazkii/Psi)-inspired and spreadsheet-like esolang. Like [Hat Trick](https://github.com/wompking/hattrick), it is evaluated using RPN. File extensions for SPREADSHEET programs are `.sprd`, and SPREADSHEET comments begin with `//`. SPREADSHEET, unlike [Tailor](https://github.com/wompking/tailorlang), is not forgiving, but it basically never throws errors anyways.
